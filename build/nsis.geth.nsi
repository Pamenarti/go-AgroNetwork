...
# 1. install agrod for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for agrod
# 5. create agrod, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since agrod is installed global
